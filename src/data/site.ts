...
export const showcasePhotos = [
  ...
  },
  {
    ...
    blurDataURL: BLUR_PLACEHOLDER,
    alt: "Family moments",
    caption: "Heartfelt interactions between loved ones.",
    label: "Family",
    location: "Gurugram",
  },
  {
    ...
    blurDataURL: BLUR_PLACEHOLDER,
    alt: "Evening glow",
    caption: "Golden hour portraits with warm lighting.",
    label: "Golden Hour",
    location: "Noida",
  },
  {
    ...
    caption: "Documenting rituals with a modern eye.",
    label: "Tradition",
    location: "Delhi",
  },
  {
    ...
    height: 4000,
    blurDataURL: BLUR_PLACEHOLDER,
    alt: "Post-wedding portraits",
    caption: "Creative sessions beyond the main event.",
    label: "Creative",
    location: "Delhi NCR",
  },
  {
    ...
    blurDataURL: BLUR_PLACEHOLDER,
    alt: "Joyous exit",
    caption: "Capturing the final moments of a grand day.",
    label: "Gratitude",
    location: "Delhi",
  },
] as const;
